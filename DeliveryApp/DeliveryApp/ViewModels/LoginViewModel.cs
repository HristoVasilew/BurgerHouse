    ...
    public class LoginViewModel : BaseViewModel
    {
        ...
        private async Task RegisterCommandAsync()
        {
            ...
            try
            {
                ...
                if (Result)
                {
                    await Application.Current.MainPage.DisplayAlert("Success", "Registration successfull", "OK");
                }
                else
                {
                    await Application.Current.MainPage.DisplayAlert("Error", "Username is busy", "OK");
                }
            }
            catch (Exception ex)
            {
